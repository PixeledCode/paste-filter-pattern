...
const moreFilterDefaultList: FilterListType = [
  "roomType",
  "participants",
  "dateCompleted",
  "department",
...
export const MoreFilters: React.FC = () => {
  ...
  const [tempSelectedMoreFilters, setTempSelectedMoreFilters] = React.useState<
    Record<string, string | string[]>
  >({});
  const [selectedMoreFilters, setSelectedMoreFilters] = React.useState<
    Record<string, string | string[]>
  >({});
